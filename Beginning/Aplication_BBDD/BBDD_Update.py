...
#----------------------------------------------Text Field--------------------------------------------------------------------------#
        ...
        self.label= Label(frame, text="Update Item").grid(row=0, column=1, sticky="w");
        #---------------#
        ...
        self.IDTxt= Label(frame, text="Where ID: ").grid(row=9, column=0, padx=4, pady=4);
        self.ID= Entry(frame);
        self.ID.grid(row=9, column=1, padx=4, pady=4);
        ...
        def Panelnew():
            ...
            bbdd.Update_Art(name, year, gender, age, sex, children, region, salary, ID);
            
            
        
        send= Button(frame, text="Send", command=Panelnew);
        send.grid(row=11, column=2, padx=4, pady=4, sticky="s");
        
        delete= Button(frame, text="Delete");
        delete.grid(row=11, column=0, padx=4, pady=4, sticky="s");
